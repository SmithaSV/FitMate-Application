...
import com.fitmate.dto.ResetPasswordRequestDto;
...
public class AuthController {
    ...
    public String resetPassword(@RequestBody @Valid ResetPasswordRequestDto request){
    ...
    public String logout(Authentication authentication){
        return "User"+ authentication.getName()+"Logout successful";
    }
}
